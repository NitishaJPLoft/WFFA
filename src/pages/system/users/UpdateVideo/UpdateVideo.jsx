...
import SelectTournament from '../../../judging/SelectTournaments';
import SelectStage from '../../../judging/SelectStages';
import SelectRound from '../../../judging/SelectRounds';
...
const JudgingList = () => {
    ...
    const getjudges = useCallback(async () => {
        ...
        const data = await helpers.systemTournaments('GET', activeRadio, stageType, tournamentId, stageId, roundId, groupId);
        if (data.status === 200) {
